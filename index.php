...
// var_dump(get_class_methods($productObj));
// exit;
...
<nav class="navbar navbar-expand-lg navbar-dark">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
      ...
      <!-- Center Search -->
      <form class="d-flex mx-auto my-2 search-form" role="search" action="" method="GET">
      ...
      <div class="nav-buttons ms-auto">
        <a href="user/login.php" class="btn btn-outline-light btn-sm">Login</a>
        <a href="admin/login.php" class="btn btn-outline-warning btn-sm">Admin</a>
        <a href="user/cart.php" class="btn btn-success btn-cart">
